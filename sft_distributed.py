...
# 日志
log_file = 'imdb_sft_gpt2large.txt'
setup_logging(log_file)


def train_ddp(rank, world_size, model_path, sentiment_model_path, train_dataset, test_dataset):
    ...
    def train(model, tokenizer, train_dataloader, test_dataloader, sentiment_model, sentiment_tokenizer, device, epochs=1, lr=5e-5, eval_steps=20, first_eval=True):
        model.train()
...
if __name__ == '__main__':
    ...
    mp.spawn(train_ddp, args=(world_size, model_path, sentiment_model_path, train_dataset, test_dataset), nprocs=world_size, join=True)
